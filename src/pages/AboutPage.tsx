    ...
    <div className="container-page py-20">
      ...
      >
        <div>
          ...
          <h1 className="mt-3 text-4xl font-semibold text-ink sm:text-5xl">Aarav Mehta</h1>
          <p className="mt-6 max-w-2xl text-lg text-ink-muted">
            I'm a computer science undergrad who got tired of AI projects that
            stop at a Jupyter notebook. Over the last two years I've shipped
            five full-stack AI systems — each with a real pipeline, a deployed
            API, and a UI a non-technical person could actually use. I care
            about the unglamorous parts: data leakage, cold-start users, and
            what happens when the model is confidently wrong. I'm looking for
            an internship where I can keep building things that have to work,
            not just demo well.
          </p>
        </div>
