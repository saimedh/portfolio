...
export const projects: Project[] = [
  ...
  },
  {
    ...
    results: [
      ...
      "Cuts down movie decision fatigue with fast, focused discovery",
      "Smooth interactive UI with instant card previews",
    ],
    lessons: [
  ...
  },
  {
    ...
    architecture: [
      ...
      "Standardized AI service layer handling rate limits and API fallbacks",
    ...
    results: [
      ...
      "Standardized backend handles rate limits, caching, and multi-model fallbacks",
  ...
  },
  {
    ...
    architecture: [
      ...
      "Time-series and spatial feature engineering (rolling averages, density clustering, temporal bins)",
    ...
    results: [
      "Working predictive pipeline with spatial hotspot mapping across urban zones",
      "Evaluated against baseline historical distributions with cross-validation",
      "Interactive visualization dashboard deployed for scenario testing",
    ],
    lessons: [
    ...
    github: "https://github.com/saimedh",
    demo: null,
    metric: { label: "Pipeline", value: "Spatiotemporal ML" },
  },
  {
    slug: "stylehub",
    name: "STYLEHUB",
